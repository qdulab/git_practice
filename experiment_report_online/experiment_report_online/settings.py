...
SECRET_KEY = '$knxga@x9z!fu(b90if7&!gs!dehw7f3sgnfeq^8isgx@h)!#6'
...
ROOT_URLCONF = 'experiment_report_online.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'experiment_report_online.wsgi.application'
